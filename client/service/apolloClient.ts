...
export function initializeApollo<T extends Record<string, any>>(initialState?: T | null) {
...
export function useApollo<T extends Record<string, any>>(initialState?: T | null) {
